...
import net.jumpingman.framework.Pool;
import net.jumpingman.framework.Pool.PoolObjectFactory;
	...
	public boolean onTouch(View v, MotionEvent event) {
		synchronized (this) {
			...
			case MotionEvent.ACTION_POINTER_DOWN:
				...
				touchEvent.time = event.getEventTime();
				touchEventsBuffer.add(touchEvent);
				break;
			case MotionEvent.ACTION_UP:
			case MotionEvent.ACTION_POINTER_UP:
			case MotionEvent.ACTION_CANCEL:
				touchEvent = touchEventPool.newObject();touchEvent.type = TouchEvent.TOUCH_UP;
				touchEvent.pointer = pointerId;
				touchEvent.x = touchX[pointerId] = (int) (event.getX(pointerIndex) * scaleX);
				touchEvent.y = touchY[pointerId] = (int) (event.getY(pointerIndex) * scaleY);
